class AcceptedJobModel {
  ...
  String? userImageUrl;
  List<AcceptedJobsList>? acceptedJobsList;
  ...
  AcceptedJobModel(
      ...
      this.afterImageUrl,
      this.userImageUrl,
      this.acceptedJobsList});

  AcceptedJobModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    beforeImageUrl = json['before_image_url'];
    afterImageUrl = json['after_image_url'];
    userImageUrl = json['user_image_url'];
    if (json['accepted_jobs_list'] != null) {
      acceptedJobsList = <AcceptedJobsList>[];
      json['accepted_jobs_list'].forEach((v) {
        acceptedJobsList!.add(new AcceptedJobsList.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.acceptedJobsList != null) {
      data['accepted_jobs_list'] =
          this.acceptedJobsList!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class AcceptedJobsList {
  ...
  AcceptedJobsList.fromJson(Map<String, dynamic> json) {
    id = json['id'];
