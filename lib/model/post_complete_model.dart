class PostCompletedModel {
  String? status;
  String? message;
  String? beforeImageUrl;
  String? afterImageUrl;
  String? userImageUrl;
  List<PostCompletedJobsList>? postCompletedJobsList;
  ...
  PostCompletedModel(
      ...
      this.afterImageUrl,
      this.userImageUrl,
      this.postCompletedJobsList});

  PostCompletedModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    message = json['message'];
    beforeImageUrl = json['before_image_url'];
    afterImageUrl = json['after_image_url'];
    userImageUrl = json['user_image_url'];
    if (json['post_completed_jobs_list'] != null) {
      postCompletedJobsList = <PostCompletedJobsList>[];
      json['post_completed_jobs_list'].forEach((v) {
        postCompletedJobsList!.add(new PostCompletedJobsList.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.postCompletedJobsList != null) {
      data['post_completed_jobs_list'] =
          this.postCompletedJobsList!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}

class PostCompletedJobsList {
  String? id;
  String? jobType;
  String? userId;
  String? postUserName;
  ...
  PostCompletedJobsList.fromJson(Map<String, dynamic> json) {
    id = json['id'];
